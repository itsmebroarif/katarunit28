...
const divisionData = {
    utama: {
        ...
        members: [
            { name: "Arif Permana Putrasuryana (RT.1)", role: { id: "Ketua Katar Unit 28", en: "Chairman", jp: "会長" } },
            { name: "(Empty) (RT.1)", role: { id: "Wakil Ketua Katar Unit 28", en: "Vice Chairman", jp: "副会長" } },
            ...
            { name: "Faradillah Eka (RT.1)", role: { id: "Wakil Sekretaris", en: "Vice Secretary", jp: "副秘書" } },
    ...
    keamanan: {
        ...
        members: [
            { name: "(Empty) (RT.1)", role: { id: "Anggota", en: "Member", jp: "メンバー" } },

...
const divisionData = {
  utama: {
    ...
    members: [
      ...
      {
        name: "Faradillah Eka (RT.1)",
        role: { id: "Wakil Sekretaris", en: "Vice Secretary", jp: "副秘書" },
      },
      {
        name: "Aqilla (RT.1)",
  ...
  humas: {
    ...
    members: [
      {
        name: "Suci Al Desti Febriyani",
        role: { id: "Anggota", en: "Member", jp: "メンバー" },
      },
      {
        name: "Safira Rahmadini",
        role: { id: "Anggota", en: "Member", jp: "メンバー" },
      },
    ],
  },
  ...
  wirausaha: {
    icon: "fas fa-store",
    title: {
      id: "KEWIRAUSAHAAN & SENI BUDAYA",
      en: "ENTREPRENEURSHIP & ARTS",
      jp: "起業家精神と芸術",
    },
    desc: {
  ...
  sistem: {
    ...
    title: {
      id: "SISTEM INFORMASI DIGITAL",
      en: "DIGITAL INFO SYSTEM",
      jp: "デジタル情報システム",
    },
    desc: {
